...
public class orderhistory_proceesing extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel=(ImageView)findViewById(R.id.imageView26);
        ...
        url2=sh.getString("url","")+"and_cancel";
...
//                params.put("shop_id",sh.getString("shop_id",""));
            ...
            Toast.makeText(getApplicationContext(),"your order is canceld",Toast.LENGTH_SHORT).show();
