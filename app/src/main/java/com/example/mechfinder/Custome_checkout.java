...
public class Custome_checkout extends BaseAdapter {

    ArrayList<String>id,service,amount;
    private Context context;

    public Custome_checkout(Context appcontext, ArrayList<String>id, ArrayList<String>service, ArrayList<String> amount)
    {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custome_checkout,null);
