...
public class Custome_orderhistory_success extends BaseAdapter {

    ArrayList<String>serid,service,seramount;
    private Context context;

    public Custome_orderhistory_success(Context appcontext, ArrayList<String>serid, ArrayList<String>service, ArrayList<String> seramount)
    {
...
//        this.status=status;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custome_orderhistory_success,null);
