...
public class orderhistory_rejected extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderhistory_rejected);
        ...
        url=sh.getString("url","")+"and_orderhistory_rejected";
