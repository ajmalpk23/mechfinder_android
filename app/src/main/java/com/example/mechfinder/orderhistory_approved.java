...
public class orderhistory_approved extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderhistory_approved);
        ...
        pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getApplicationContext(),upi.class).putExtra("srid",service_requestid).putExtra("name",username.getText().toString()).putExtra("payment",totalamount1.getText().toString()));
        ...
        url=sh.getString("url","")+"and_orderhistory_approved";
